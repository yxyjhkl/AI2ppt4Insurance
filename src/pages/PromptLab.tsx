...
import { Copy, Sparkles, Bookmark, Search } from 'lucide-react'
...
const promptCategories = [
  ...
  },
  {
    ...
    prompts: [
      ...
      { title: '业务述职会', content: '述职PPT：业绩达成概览、关键成果展示、过程管理、能力成长、不足反思、改进措施、未来规划、支持需求。70%成果+30%反思。' },
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-800">提示词库</h1>
