...
| 📑 模板系统 | 22 套内置专业模板 + 支持 PPTX 导入自定义模板 |
| 🎨 可视化编辑 | 画布拖拽编辑，17 种专业布局自由切换，实时 SVG 预览 |
| 🔍 P0-P3 质检 | 四级内容质量检查：阻断/警告/建议/优化 |
| 📥 多格式导出 | PPTX / PDF / 分页 PNG，支持 OOXML 动画 |
| 💻 离线可用 | Ollama 本地模型 + 离线规则引擎，无网络也能生成 |
